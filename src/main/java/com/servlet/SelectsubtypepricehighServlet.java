 ...
 */
@WebServlet("/selectsubtypebypricehigh")
public class SelectsubtypepricehighServlet extends AutowiredHttpServlet {
    @Autowired
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int productnum = productservice.getTotalNumBySubtype(subtype);
        List<Product> productlist  = productservice.getProductlistBySubTypePricehigh(subtype,currnum);
