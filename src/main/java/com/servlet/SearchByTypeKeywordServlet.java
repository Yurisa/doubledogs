 ...
 */
@WebServlet("/searchbytypekeyword")
public class SearchByTypeKeywordServlet extends AutowiredHttpServlet {
    @Autowired
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int productnum = productservice.getTotalNumTypeKeyword(type,keyword);
        System.out.println(productnum);
        List<Product> productlist  = productservice.getProductlistByTypeKeyword(type,keyword,currnum);
