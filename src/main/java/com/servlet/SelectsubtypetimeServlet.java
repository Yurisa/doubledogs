 ...
 */
@WebServlet("/selectsubtypebytime")
public class SelectsubtypetimeServlet extends AutowiredHttpServlet {
    @Autowired
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Product> productlist  = productservice.getProductlistBySubTypeTime(type,currnum);
