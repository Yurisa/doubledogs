 ...
 */
@WebServlet("/sortbypricehigh")
public class SortbypricehighServlet extends AutowiredHttpServlet {
    @Autowired
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Product> productlist = productservice.getProductlistSortByPricehigh(currnum);
