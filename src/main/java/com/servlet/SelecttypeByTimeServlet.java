 ...
 */
@WebServlet("/selecttypebytime")
public class SelecttypeByTimeServlet extends AutowiredHttpServlet{
    @Autowired
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Product> productlist  = productservice.getProductlistByTypeTime(type,currnum);
